...
class SolverPdfExportAdapter:
    ...
    Layout (Letter, 0.4in margins): first page uses a dedicated region map
    with the grid in the upper-right two-thirds, clues in the left third,
    then clues continue in the lower-right two columns before flowing to
    three-column continuation pages.
    """
